...
// Methods are of two types :- 
   //  1.static methods
   //    it is declared inside a class before main method , with static keyword.
   //  2.instance methods
   //     it is declared inside main method with object reference.

   // Access modifiers in java are basically :-
   //   1. public
   //       => can be accessed anywhere and in any package with pulic keyword.
   //    private
   //       => can be accessed inside the same class within the same package.
   //    protected
   //       => can be accessed inside the class within a package and in other package also.
   //    default